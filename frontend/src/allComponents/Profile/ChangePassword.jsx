...
const ChangePassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    e.preventDefault(); 
    try {
      const res = await axiosInstance.put(`/user/updatePassword/${id}`, { password, newPassword },config);
  ...
  return (
    ...
    <div className="flex">
      ...
      <form>
        ...
        <span className="text-[2rem] text-center font-bold">Change  Password</span>
