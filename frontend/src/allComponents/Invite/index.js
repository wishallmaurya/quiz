...
function Invite({ navigation }) {
  ...
  return (
    <Skeleton>
      ...
      <div className="bg-[#152C4F] h-auto p-16 w-full ">
      ...
      <div className=" flex justify-center mt-5 relative bottom-16">
        <div className=" bg-[#FCFCFC] h-auto w-2/3 rounded-xl sm:shadow-md shadow-inner pb-10">
          <div className="flex justify-center ">
            <div className="text-2xl text-[#282828] font-medium mt-10 px-10">
              Refer a friend! Give 500 Points, Get 500 Points
            </div>
          </div>
          <div className="flex justify-center ">
            <div className="text-sm text-[#282828] w-96 text-center mt-16 px-10">
              Get your referral link to give your friends 500 pts when they join
              on Oliva Ministries Quizzes via your link/code. If they join it,
              we’ll reward you with 500 pts and more exciting rewards
            </div>
          </div>
          <div className="flex justify-center text-sm mt-4 text-blue-400 hover:text-blue-700">
            <Link to={"/termsAndCondition"} className="underline ">
              Terms & Conditions
            </Link>
          </div>
          <div className="flex justify-center text-sm mt-4 ">
            <div className=" text-sm font-bold">Invite now using:</div>
          </div>
          <div className="flex justify-center text-sm mt-4 ">
            <a
          ...
          <div className="flex justify-center text-sm mt-4 ">
            <div
              className="flex  justify-between border-solid border-2"
              style={{ height: "2rem", width: "20rem" }}
            >
              <p className="p-1 font-bold">{copyText}</p>
